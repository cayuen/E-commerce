//  Ajax JavaScript code for the form.html document

/********************************************************/
//  Below code written by Sam Malek
//  function getPlace
//  parameter: zip code
...
function getPlace (zip)
{
  ...
  //xhr.open ("GET", "../html/getCityState.php?zip=" + zip, true);
  //xhr.send ();
  xhr.open ("POST", "../html/getCityState.php", true);
